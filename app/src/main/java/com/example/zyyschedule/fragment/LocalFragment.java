...
import com.example.zyyschedule.databinding.FragmentLocalBinding;
...
public class LocalFragment extends Fragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        binding.localScheduleList.setLayoutManager(localSchedule);
    ...
    private void UpdateScheduleList() {
        vm.allUFScheduleByTime().observe(getViewLifecycleOwner(), schedules -> {
            for (int i = 0; i < schedules.size(); i++) {
        ...
        vm.allFScheduleByTime().observe(getViewLifecycleOwner(), schedules -> {
            for (int i = 0; i < schedules.size(); i++) {
