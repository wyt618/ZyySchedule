...
public class CalendarWeekView extends WeekView {
    ...
    protected void onDrawScheme(Canvas canvas, Calendar calendar, int x) {
        ...
        canvas.drawCircle(x + mItemWidth / 2, mItemHeight - 3 * mPadding, mPointRadius, BackgroundPaint);
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, boolean hasScheme, boolean isSelected) {
        ...
        if(hasScheme){
            ...
            canvas.drawText(calendar.getScheme(), x + mItemWidth - mPadding*19 - mCircleRadius, mPadding + mSchemeBaseLine, dateTextPaint);
        }
        ...
        if (isSelected) {
            ...
            canvas.drawText(calendar.getLunar(), cx, mTextBaseLine + mItemHeight / 10,
                    calendar.isCurrentDay() ? mCurDayLunarTextPaint :
                            !TextUtils.isEmpty(calendar.getSolarTerm()) ? SolarTextPaint :
